...
class Data extends \Magento\Framework\App\Helper\AbstractHelper
{
    ...
    */
    ...
    {
        return $this->scopeConfig->isSetFlag(
            'lof_ajaxcart/general/enabled_product_view',
            \Magento\Store\Model\ScopeInterface::SCOPE_STORE
        );
    }
    ...
    {
        return $this->scopeConfig->isSetFlag(
            'lof_ajaxcart/success_popup/product_image',
            \Magento\Store\Model\ScopeInterface::SCOPE_STORE
        );
    }
    ...
    {
        return $this->scopeConfig->getValue(
            'lof_ajaxcart/success_popup/product_image_size',
            \Magento\Store\Model\ScopeInterface::SCOPE_STORE
        );
    }
    ...
    {
        return $this->scopeConfig->isSetFlag(
            'lof_ajaxcart/success_popup/product_price',
            \Magento\Store\Model\ScopeInterface::SCOPE_STORE
        );
    }
    ...
    {
        return $this->scopeConfig->isSetFlag(
            'lof_ajaxcart/success_popup/continue_button',
            \Magento\Store\Model\ScopeInterface::SCOPE_STORE
        );
    }
    ...
    {
        return $this->scopeConfig->getValue(
            'lof_ajaxcart/success_popup/enabled_countdown',
            \Magento\Store\Model\ScopeInterface::SCOPE_STORE
        );
    }
    ...
    {
        return $this->scopeConfig->getValue(
            'lof_ajaxcart/success_popup/countdown_time',
            \Magento\Store\Model\ScopeInterface::SCOPE_STORE
        );
    }
    ...
    {
        return $this->scopeConfig->isSetFlag(
            'lof_ajaxcart/success_popup/mini_cart',
            \Magento\Store\Model\ScopeInterface::SCOPE_STORE
        );
    }
    ...
    {
        return $this->scopeConfig->isSetFlag(
            'lof_ajaxcart/success_popup/mini_checkout',
            \Magento\Store\Model\ScopeInterface::SCOPE_STORE
        );
    }
    ...
    {
        return $this->scopeConfig->isSetFlag(
            'lof_ajaxcart/success_popup/suggest_product',
            \Magento\Store\Model\ScopeInterface::SCOPE_STORE
        );
    }
    ...
    {
        return $this->scopeConfig->getValue(
            'lof_ajaxcart/success_popup/suggest_title',
            \Magento\Store\Model\ScopeInterface::SCOPE_STORE
        );
    }
    ...
    {
        return $this->scopeConfig->getValue(
            'lof_ajaxcart/success_popup/suggest_source',
            \Magento\Store\Model\ScopeInterface::SCOPE_STORE
        );
    }
    ...
    {
        return $this->scopeConfig->getValue(
            'lof_ajaxcart/success_popup/suggest_limit',
            \Magento\Store\Model\ScopeInterface::SCOPE_STORE
        );
    }
    ...
    public function getBtnTextColor()
    {
        $color = $this->scopeConfig->getValue(
            'lof_ajaxcart/success_popup_design/button_text_color',
            \Magento\Store\Model\ScopeInterface::SCOPE_STORE
        );
    ...
    {
        return $this->scopeConfig->getValue(
            'lof_ajaxcart/success_popup_design/continue_text',
            \Magento\Store\Model\ScopeInterface::SCOPE_STORE
        );
    }
    ...
    public function getBtnContinueBackground()
    {
        $backGround = $this->scopeConfig->getValue(
            'lof_ajaxcart/success_popup_design/continue',
            \Magento\Store\Model\ScopeInterface::SCOPE_STORE
        );
    ...
    public function getBtnContinueHover()
    {
        $hover = $this->scopeConfig->getValue(
            'lof_ajaxcart/success_popup_design/continue_hover',
            \Magento\Store\Model\ScopeInterface::SCOPE_STORE
        );
    ...
    {
        return $this->scopeConfig->getValue(
            'lof_ajaxcart/success_popup_design/viewcart_text',
            \Magento\Store\Model\ScopeInterface::SCOPE_STORE
        );
    }
    ...
    {
        $backGround = $this->scopeConfig->getValue(
            'lof_ajaxcart/success_popup_design/viewcart',
            \Magento\Store\Model\ScopeInterface::SCOPE_STORE
        );
    ...
    {
        $hover = $this->scopeConfig->getValue(
            'lof_ajaxcart/success_popup_design/viewcart_hover',
            \Magento\Store\Model\ScopeInterface::SCOPE_STORE
        );
    ...
    {
        return $this->scopeConfig->getValue(
            'lof_ajaxcart/success_popup_design/freeShipping_message',
            \Magento\Store\Model\ScopeInterface::SCOPE_STORE
        );
    }
    ...
    {
        return $this->scopeConfig->getValue(
            'lof_ajaxcart/success_popup_design/congratulation',
            \Magento\Store\Model\ScopeInterface::SCOPE_STORE
        );
    }
    ...
    {
        return $this->scopeConfig->isSetFlag(
            'lof_ajaxcart/quickview_popup/go_to_product',
            \Magento\Store\Model\ScopeInterface::SCOPE_STORE
        );
    }
    ...
    {
        return $this->scopeConfig->isSetFlag(
            'lof_ajaxcart/quickview_popup/additional_data',
            \Magento\Store\Model\ScopeInterface::SCOPE_STORE
        );
    }
