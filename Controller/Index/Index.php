...
class Index extends \Magento\Framework\App\Action\Action
{
     ...
     *
     * @var \Lof\Ajaxcart\Filter\LocalizedToNormalized
     */
     ...
     * @param \Lof\Ajaxcart\Filter\LocalizedToNormalized $localizedToNormalized
    ...
    public function __construct(
        ...
        \Lof\Ajaxcart\Filter\LocalizedToNormalized $localizedToNormalized,
    ...
    private function returnResult($resultItem, $relatedAdded)
    {
        ...
        if (!$this->cart->getQuote()->getHasError()) {
            ...
            $popupBlock = $resultPage->getLayout()
                ...
                ->setTemplate('Lof_Ajaxcart::popup.phtml')
                ->setItem($resultItem)
    ...
    /**
     * Add message from lof_ajaxcart_add_before result
     *
     * @param array $message
     * @return void
     */
